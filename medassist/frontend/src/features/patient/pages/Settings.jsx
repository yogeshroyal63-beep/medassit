...
const Settings = () => {
  ...
  const handlePasswordSubmit = async (e) => {
    ...
    setSaving(true);
    try {
      await api.put("/users/me/password", { currentPassword: passwords.current, newPassword: passwords.next });
  ...
  return (
    <div style={{ maxWidth: "480px" }}>
      ...
      <div style={{
        ...
        <h2 style={{ margin: "0 0 0.4rem", fontSize: "14px", fontWeight: 700, color: "var(--danger-text)", display: "flex", alignItems: "center", gap: "7px" }}>
          <LogOut size={15} /> Danger Zone
        </h2>
        <p style={{ margin: "0 0 0.85rem", fontSize: "12.5px", color: "var(--text-muted)" }}>
